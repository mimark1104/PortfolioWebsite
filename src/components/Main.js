      ...
      >
        ...
        <Container>
          ...
          <Center click={click}>
            ...
            <span>WARNING! Do not click here</span>
          </Center>
          ...
          {mq ? (
            <Contact
              click={+click}
              target="_blank"
              to={{ pathname: "mailto:raymark.presno@gmail.com" }}
            >
              <motion.h3
                initial={{
                  y: -200,
          ...
          {mq ? (
            <BLOG click={+click} onClick={() => setpath("art")} to="/art">
              <motion.h2
                initial={{
                  y: -200,
                  transition: { type: "spring", duration: 1.5, delay: 1 },
            ...
            <BLOG click={+false} onClick={() => setpath("blog")} to="/art">
              <motion.h2
                initial={{
                  y: -200,
                  transition: { type: "spring", duration: 1.5, delay: 1 },
